...
const RETURN_SPEED = 0.08; // How fast particles fly back to origin
...
export const ParticleCanvas = () => {
    ...
    const initParticles = useCallback((width, height) => {
        ...
        for (let i = 0; i < particleCount; i++) {
            ...
            newParticles.push({
                ...
                color: Math.random() > 0.9 ? '#38bdf8' : '#ffffff', // EmpoderaTech cyan or white
    ...
    const animate = useCallback((time) => {
        ...
        // 1. Pulsating Radial Glow (EmpoderaTech blue)
        ...
        gradient.addColorStop(0, `rgba(2, 85, 186, ${pulseOpacity})`); // EmpoderaTech Blue
            ...
            for (let j = i + 1; j < particles.length; j++) {
                ...
                if (distSq < minDist * minDist) {
                    ...
                    if (dist > 0.01) {
                        ...
                        // Static Resolution: Push particles apart
    ...
    return (
        ...
        >
            ...
            <div className="absolute bottom-4 right-4 pointer-events-none text-xs text-white/20 font-mono text-right">
                <p>{debugInfo.count} partículas</p>
